...
const string AGE_VERSION = "r0.2.1_dev4";
...
//Error FLAGS
const int AGE_ERRORFLAG_GENERIC = -1;
const int AGE_ERRORFLAG_FILEACCESS = -2;
const int AGE_ERRORFLAG_NOREGISTER = -3;
const int AGE_ERRORFLAG_IMAGEDRAW = -4;
const int AGE_ERRORFLAG_RENDERPROCESS = -5;
const int AGE_ERRORFLAG_NODRAWAREA = -6;
const int AGE_ERRORFLAG_NOWINDOW = -7;
const int AGE_ERRORFLAG_NORENDER = -8;
const int AGE_ERRORFLAG_SIZE = -9;
const int AGE_ERRORFLAG_FONTID = -15;
const int AGE_ERRORFLAG_FONTLOAD = -16;
...
//Label mode FLAGS
const int AGE_LABELMODEFLAG_BLENDED = 89;
const int AGE_LABELMODEFLAG_SOLID = 90;
const int AGE_LABELMODEFLAG_SHADED = 91;

//Object identifier FLAGS
const int AGE_IDFLAG_WINDOW = 92;
const int AGE_IDFLAG_IMAGE = 93;
const int AGE_IDFLAG_DRAWAREA = 94;
const int AGE_IDFLAG_EVENT = 95;
